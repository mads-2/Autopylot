#This is the arguement format: python autopilot.py -i test_input.yaml
import os
...
def read_single_arguments():
    ...
    parser.add_argument("-i", "--input_yaml", type=Path, required=True, help="Path of yaml input file") # File test_input.yaml contains input parameters of TC computation
...
def main():
    ...
    # Above lines read parameters in .yaml
    if 'optimization' in settings: 
        ...
        opt_settings = {
                ...
                'precision': 'mixed',
                'gpus': '2'
        } # Generate optimization convergence parameters
